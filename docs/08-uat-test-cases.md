...
| UAT-010 | Calculate approval route | Total exposure is MYR 1.2m, risk level is Medium, and collateral is partially secured. | Run approval route calculation. | Regional Credit Manager or Country Credit Committee route is recommended based on configured rule score. | High |
